...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Mon Apr 16 17:09:08 2012
# Project:  window.pro
# Template: app
...
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS)  -L/usr/lib -L/usr/local/lib -lpcap -lQtXml -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/window1.0.0/ && $(COPY_FILE) --parents mainwindow.h startdialog.h domitem.h dommodel.h highlighter.h .tmp/window1.0.0/ && $(COPY_FILE) --parents mainwindow.qrc .tmp/window1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp startdialog.cpp domitem.cpp dommodel.cpp highlighter.cpp .tmp/window1.0.0/ && $(COPY_FILE) --parents mainwindow.ui startdialog.ui .tmp/window1.0.0/ && (cd `dirname .tmp/window1.0.0` && $(TAR) window1.0.0.tar window1.0.0 && $(COMPRESS) window1.0.0.tar) && $(MOVE) `dirname .tmp/window1.0.0`/window1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/window1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_startdialog.cpp moc_dommodel.cpp moc_highlighter.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_startdialog.cpp moc_dommodel.cpp moc_highlighter.cpp
...
moc_dommodel.cpp: dommodel.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) dommodel.h -o moc_dommodel.cpp
...
dommodel.o: dommodel.cpp domitem.h \
		dommodel.h
