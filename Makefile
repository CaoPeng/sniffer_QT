...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Wed Apr 11 14:14:21 2012
# Project:  window.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		startdialog.cpp \
		domitem.cpp \
		dommodel.cpp moc_mainwindow.cpp \
		moc_startdialog.cpp \
		moc_dommodel.cpp \
		qrc_mainwindow.cpp
OBJECTS       = main.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/window1.0.0/ && $(COPY_FILE) --parents mainwindow.h startdialog.h domitem.h dommodel.h .tmp/window1.0.0/ && $(COPY_FILE) --parents mainwindow.qrc .tmp/window1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp startdialog.cpp domitem.cpp dommodel.cpp .tmp/window1.0.0/ && $(COPY_FILE) --parents mainwindow.ui startdialog.ui .tmp/window1.0.0/ && (cd `dirname .tmp/window1.0.0` && $(TAR) window1.0.0.tar window1.0.0 && $(COMPRESS) window1.0.0.tar) && $(MOVE) `dirname .tmp/window1.0.0`/window1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/window1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_startdialog.cpp moc_dommodel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_startdialog.cpp moc_dommodel.cpp
