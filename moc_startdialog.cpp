...
**
** Created: Mon May 7 14:33:12 2012
...
void *startDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_startDialog"))
        return static_cast< Ui_startDialog*>(const_cast< startDialog*>(this));
...
int startDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: setDevice((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: comboBoxChange(); break;
        default: ;
        }
        _id -= 2;
    }
